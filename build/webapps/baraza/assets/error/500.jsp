...
<head>
<meta charset="utf-8"/>
<title>500 | <%= pageContext.getServletContext().getInitParameter("web_title") %></title>
...
<link href="${contextPath}/assets/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="${contextPath}/assets/admin/layout4/css/themes/light.css" rel="stylesheet" type="text/css"/>
...
<script src="${contextPath}/assets/admin/layout4/scripts/layout.js" type="text/javascript"></script>
<script src="${contextPath}/assets/admin/layout4/scripts/demo.js" type="text/javascript"></script>
<script>
