...
CREATE TABLE applications (
	...
	openapplication			boolean default false not null,
...
CREATE TABLE registrations (
	...
	previousapplications	boolean default false not null,
	previousadmitted		boolean default false not null,
	admittedyear			varchar(12),
	admitttedmajorid		varchar(12) references majors,
	previoussuspended		boolean default false not null,
	suspendedperiod			varchar(12),
	drugabuse				boolean default false not null,
	drugtherapies			varchar(240),
	cultmemeber				boolean default false not null,
...
CREATE TABLE registryexams (
	...
	examname			varchar(50),
	internalexam		boolean default false not null,
	examdate			date,
	narrative			varchar(240)
);
