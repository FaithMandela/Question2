...
CREATE OR REPLACE FUNCTION aft_registrations() RETURNS trigger AS $$
DECLARE
...
CREATE TRIGGER aft_registrations AFTER UPDATE ON registrations
	FOR EACH ROW EXECUTE PROCEDURE aft_registrations();
