...
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (1, 1, 5, 10, '2008-01-01', '2010-02-02', NULL, 'L');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (2, 2, 5, 10, '2008-01-01', '2016-08-24', NULL, 'L');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (7, 7, 35, 50, '2008-01-01', '2016-08-17', NULL, 'IE');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (8, 8, 40, 60, '2008-01-01', '2016-08-10', NULL, 'IB');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (3, 3, 10, 20, '2008-01-01', '2016-08-10', NULL, 'REE');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (4, 4, 15, 25, '2008-01-01', '2016-03-03', NULL, 'REB');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (6, 6, 25, 40, '2008-01-01', '2016-08-17', NULL, 'RAB');
INSERT INTO points_scaling (scaling_id, class_id, one_way, isreturn, start_date, end_date, details, code) VALUES (5, 5, 20, 30, '2008-01-01', '2016-08-11', NULL, 'RAE');
--
...
INSERT INTO points_value (point_value_id, point_value, start_date, end_date, details) VALUES (1, 5, '2008-01-01', '2016-08-31', NULL);
...
INSERT INTO product_category (product_category_id, product_category_name, details, icon) VALUES (2, 'Airport transfers', NULL, NULL);
...
INSERT INTO products (product_id, product_category_id, supplier_id, created_by, product_name, product_uprice, product_ucost, created, product_details, terms, weight, remarks, is_active, updated_by, updated, narrative, image, details) VALUES (7, 2, 3, NULL, 'Airport transfer Ksh 2,000', 2000, NULL, '2016-06-28', NULL, NULL, NULL, NULL, true, NULL, '2016-06-28 09:26:11.388658', NULL, NULL, NULL);
...
<p>Travel Creations Team</p>
', 2);
INSERT INTO sys_emails (sys_email_id, org_id, sys_email_name, default_email, title, details, use_type) VALUES (6, NULL, 'Reset Password', NULL, 'Password Reset', '<p>Dear {{name}},</p>
...
SELECT pg_catalog.setval('sys_emails_sys_email_id_seq', 6, true);
...
INSERT INTO workflows (workflow_id, source_entity_id, org_id, workflow_name, table_name, table_link_field, table_link_id, approve_email, reject_email, approve_file, reject_file, details) VALUES (2, 4, NULL, 'Period poins approval', 'periods', NULL, NULL, '<p>Request approved</p>
