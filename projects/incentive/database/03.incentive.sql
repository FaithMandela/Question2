...
CREATE OR REPLACE VIEW vw_loyalty_points AS
    ...
    SELECT a.dr, a.cr, a.order_date::date, a.client_code, a.org_name, a.entity_id,
		...
		CREATE OR REPLACE VIEW vw_city_codes AS
			SELECT city_codes.city_code, city_codes.city_name, city_codes.country, city_codes.sys_country_id,
			sys_countrys.sys_continent_id
			FROM city_codes
			JOIN sys_countrys ON sys_countrys.sys_country_id = city_codes.sys_country_id;
