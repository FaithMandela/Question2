...
CREATE OR REPLACE VIEW vw_loan_disburse_acc AS 
SELECT 
	entitys.entity_id,vw_deposit_accounts.member_id,vw_deposit_accounts.member_name,vw_deposit_accounts.business_account,
	...
	vw_deposit_accounts.activity_frequency_id,vw_deposit_accounts.activity_frequency_name,vw_deposit_accounts.org_id,
	vw_deposit_accounts.org_name,vw_deposit_accounts.deposit_account_id,vw_deposit_accounts.is_active,
	(vw_deposit_accounts.account_number) AS disburse_account,vw_deposit_accounts.narrative,vw_deposit_accounts.last_closing_date,
    ...
    FROM vw_deposit_accounts INNER JOIN entitys ON entitys.member_id = vw_deposit_accounts.member_id
    WHERE vw_deposit_accounts.product_no = 1 AND vw_deposit_accounts.business_account = 0;
