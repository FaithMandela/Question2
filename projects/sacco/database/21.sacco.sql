...
CREATE  OR REPLACE VIEW vw_deposit_accounts AS
	SELECT members.member_id, members.member_name, members.business_account,
		vw_products.product_id, vw_products.product_no, vw_products.product_name, 
...
CREATE OR REPLACE VIEW vw_entity_accounts AS
	SELECT vw_deposit_accounts.member_id, vw_deposit_accounts.member_name, vw_deposit_accounts.business_account,
		vw_deposit_accounts.product_id, vw_deposit_accounts.product_no,vw_deposit_accounts.product_name, 
...
CREATE OR REPLACE VIEW vw_account_activity_p AS
SELECT
    entitys.entity_id,entitys.entity_type_id,
    
    vw_account_activity.member_id,vw_account_activity.member_name,vw_account_activity.business_account,
    vw_account_activity.product_id,vw_account_activity.product_no,vw_account_activity.product_name,
    vw_account_activity.deposit_account_id,vw_account_activity.is_active,vw_account_activity.account_number,
    vw_account_activity.last_closing_date,vw_account_activity.activity_type_id,vw_account_activity.activity_type_name,
    vw_account_activity.dr_account_id,dr_account_no,vw_account_activity.dr_account_name,vw_account_activity.cr_account_id,
    vw_account_activity.cr_account_no,vw_account_activity.cr_account_name,vw_account_activity.use_key_id,
    vw_account_activity.use_key_name,vw_account_activity.activity_frequency_id,vw_account_activity.activity_frequency_name,
    vw_account_activity.activity_status_id,vw_account_activity.activity_status_name,vw_account_activity.currency_id,
    vw_account_activity.currency_name,currency_symbol,vw_account_activity.transfer_account_id, 
    vw_account_activity.trnf_account_number,vw_account_activity.trnf_member_id,vw_account_activity.trnf_member_name,
    vw_account_activity.trnf_product_id,trnf_product_name,vw_account_activity.period_id,vw_account_activity.start_date,
    vw_account_activity.end_date,vw_account_activity.fiscal_year_id,vw_account_activity.fiscal_year,
    vw_account_activity.org_id,vw_account_activity.account_activity_id,vw_account_activity.activity_date,
    vw_account_activity.value_date,vw_account_activity.transfer_account_no,vw_account_activity.transfer_link_id,
    vw_account_activity.account_credit,vw_account_activity.account_debit,vw_account_activity.balance,vw_account_activity.exchange_rate,
    vw_account_activity.application_date,vw_account_activity.approve_status,vw_account_activity.workflow_table_id,
    vw_account_activity.action_date,vw_account_activity.details,vw_account_activity.base_credit,vw_account_activity.base_debit

    FROM vw_account_activity
    INNER JOIN entitys ON entitys.member_id = vw_account_activity.member_id;

CREATE OR REPLACE VIEW vw_trx_shares AS
SELECT aa.member_id,aa.member_name, aa.org_id, aa.deposit_account_id, aa.account_number AS trx_accno, aa.product_id, aa.product_no, 
 aa.product_name, 
    ab.account_number AS transfer_account_no
     FROM vw_deposit_accounts aa
     LEFT JOIN ( SELECT vw_deposit_accounts.member_id,
            vw_deposit_accounts.account_number
           FROM vw_deposit_accounts
          WHERE vw_deposit_accounts.product_no = 3) ab ON aa.member_id::text = ab.member_id::text
          WHERE aa.product_no = 1;
