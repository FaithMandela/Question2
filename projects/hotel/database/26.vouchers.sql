...
CREATE OR REPLACE VIEW vw_asset_seasons AS
    ...
    INNER JOIN seasons ON asset_seasons.season_id =  seasons.season_id;
...
CREATE OR REPLACE VIEW vw_rates AS
    ...
    CREATE OR REPLACE VIEW vw_vouchers AS
        ...
        vouchers.ababycot, vouchers.single, vouchers.no_adults, vouchers.room_type_id, vouchers.double, vouchers.children_age,
        ...
        entitys.entity_name
        FROM entitys
        INNER JOIN vouchers ON entitys.entity_id = vouchers.client_id
