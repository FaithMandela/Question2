...
INSERT INTO entitys (entity_id, org_id, entity_type_id, entity_name, user_name, super_user, entity_leader, function_role, is_active, account_id, attention, use_function) 
VALUES (3, 0, 2, 'ABCD Kenya', 'abcd', false, false, 'client', true, 30000, 'Jane Kamango', 2);
INSERT INTO entitys (entity_id, org_id, entity_type_id, user_name, entity_name, primary_email,  account_id, use_function)
VALUES (4, 0, 3, 'XYZ Kenya', 'xyz', 'xyz@localhost',  40000, 3);
...
INSERT INTO address (sys_country_id, table_name, table_id, post_office_box, postal_code, premises, street, town, phone_number, extension, mobile, fax, email, website, is_default, first_password, details) 
VALUES ('KE', 'entitys', 3, '41010', '00100', 'Barclays Plaza, 7th Floor', 'Loita Street', 'Nairobi', '+254 20 3274233/5', NULL, NULL, NULL, 'info@abcdkenya.com', 'www.abcdkenya.com', true, NULL, NULL);
INSERT INTO address (sys_country_id, table_name, table_id, post_office_box, postal_code, premises, street, town, phone_number, extension, mobile, fax, email, website, is_default, first_password, details) 
VALUES ('KE', 'entitys', 4, '41010', '00100', 'Barclays Plaza, 8th Floor', 'Loita Street', 'Nairobi', '+254 20 32742243', NULL, NULL, NULL, 'info@xyzkenya.com', 'www.xyzkenya.com', true, NULL, NULL);
