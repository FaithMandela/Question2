  ...
  CREATE OR REPLACE VIEW vw_passengers AS
	...
	passengers.rates,passengers.rates*passengers.totalAmount_covered as kesTotalAmount
  	FROM passengers
...
SELECT
	...
	a.is_valid, a.is_individual, a.portal_id, a.portal_name,p.kesamount,p.rates,p.rates*p.totalamount_covered as kesTotalAmount
	...
	a.portal_id,a.portal_name,  a.id_no, a.relationship,a.kesamount,a.rates,a.kesTotalAmount
	FROM ((
	SELECT org_id,org_name,rate_type_id, rate_plan_id, rate_category_name,rate_id, rate_plan_name, standard_rate, north_america_rate,
	    ...
	    portal_id, portal_name,id_no,relationship,kesamount,rates,rates*totalAmount_covered as kesTotalAmount
	FROM vw_passengers  )
	UNION ALL
	(SELECT org_id,org_name, rate_type_id,  rate_plan_id,  rate_category_name, rate_id,    rate_plan_name,  standard_rate,
	    ...
	    is_active,  is_valid,is_individual,portal_id, portal_name, ''::text as id_no,''::text as relationship,kesamount,rates,rates*totalamount_covered as kesTotalAmount
