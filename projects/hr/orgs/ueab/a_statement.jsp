...
<%
	...
	allowXml.add("hr.xml");allowXml.add("payroll.xml");allowXml.add("projects.xml");allowXml.add("finance.xml");
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12" >
					<div class="tabbable tabbable-tabdrop"></div>

					<div class="portlet box <%= web.getViewColour() %>">
						<div class="portlet-title">
							<div class="caption">
								<i class="<%= web.getViewIcon() %>"></i>Financial Statement
							</div>
							<div class="tools">
						</div>

						<div class="portlet-body" id="portletBody" style="min-height:360px;">
							<%@ include file="a_statement_inc.jsp" %>
						</div>
					</div>
                </div>
            </form>
