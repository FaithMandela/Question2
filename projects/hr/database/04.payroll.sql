...
CREATE VIEW vw_employee_tax_types AS
	SELECT vw_employee_month.employee_month_id, vw_employee_month.period_id, vw_employee_month.start_date, 
		...
		employee_tax_types.org_id, employee_tax_types.employee_tax_type_id, employee_tax_types.tax_identification, employee_tax_types.amount, 
	...
	FROM employee_tax_types INNER JOIN vw_employee_month ON employee_tax_types.employee_month_id = vw_employee_month.employee_month_id
...
CREATE VIEW vw_employee_advances AS
	...
	FROM employee_advances INNER JOIN vw_employee_month ON employee_advances.employee_month_id = vw_employee_month.employee_month_id;
...
CREATE VIEW vw_advance_deductions AS
	...
	FROM advance_deductions INNER JOIN vw_employee_month ON advance_deductions.employee_month_id = vw_employee_month.employee_month_id;
...
CREATE VIEW vw_employee_overtime AS
	...
	FROM employee_overtime INNER JOIN vw_employee_month ON employee_overtime.employee_month_id = vw_employee_month.employee_month_id;
...
CREATE VIEW vw_employee_per_diem AS
	...
	FROM employee_per_diem INNER JOIN vw_employee_month ON employee_per_diem.employee_month_id = vw_employee_month.employee_month_id;
...
CREATE VIEW vw_employee_banking AS
	SELECT vw_employee_month.employee_month_id, vw_employee_month.period_id, vw_employee_month.start_date, 
		...
		employee_banking.org_id, employee_banking.default_banking_id, employee_banking.amount, 
	...
	FROM employee_banking INNER JOIN vw_employee_month ON employee_banking.employee_month_id = vw_employee_month.employee_month_id
